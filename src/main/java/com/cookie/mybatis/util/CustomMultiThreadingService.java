...
public class CustomMultiThreadingService {
    ...
    public void executeAysncTask1(Integer i){
        logger.info("CustomMultiThreadingService ==> executeAysncTask1 method: 执行异步任务{}==>线程{} ", i,Thread.currentThread().getId());
    }
    ...
    public void executeAsyncTask2(Integer i){
        logger.info("CustomMultiThreadingService ==> executeAsyncTask2 method: 执行异步任务{}==>线程{} ", i,Thread.currentThread().getId());
    }
}